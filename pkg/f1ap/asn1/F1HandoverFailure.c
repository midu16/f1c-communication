...
static asn_TYPE_member_t asn_MBR_F1HandoverFailure_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct F1HandoverFailure, transactionID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct F1HandoverFailure, cause),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_cause_3,
		0,	/* Defer constraints checking to the member type */
...
static const ber_tlv_tag_t asn_DEF_F1HandoverFailure_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_F1HandoverFailure_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transactionID */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cause */
};
static asn_SEQUENCE_specifics_t asn_SPC_F1HandoverFailure_specs_1 = {
	sizeof(struct F1HandoverFailure),
	offsetof(struct F1HandoverFailure, _asn_ctx),
	asn_MAP_F1HandoverFailure_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_F1HandoverFailure = {
	"F1HandoverFailure",
	"F1HandoverFailure",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_F1HandoverFailure_tags_1,
	sizeof(asn_DEF_F1HandoverFailure_tags_1)
		/sizeof(asn_DEF_F1HandoverFailure_tags_1[0]), /* 1 */
	asn_DEF_F1HandoverFailure_tags_1,	/* Same as above */
	sizeof(asn_DEF_F1HandoverFailure_tags_1)
		/sizeof(asn_DEF_F1HandoverFailure_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_F1HandoverFailure_1,
	2,	/* Elements count */
	&asn_SPC_F1HandoverFailure_specs_1	/* Additional specs */
};
